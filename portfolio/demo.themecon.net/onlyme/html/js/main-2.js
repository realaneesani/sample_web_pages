(function ($) {
    ...
    jQuery(document).ready(function ($) {
        ...
        //---------fullpage js---------
        $('#fullpage').fullpage({
            anchors: ['home', 'aboutMe', 'portfolio', 'skill', 'services', 'testimonial', 'blog', 'instagram', 'contact'],
            menu: '#main-menu',
            responsiveWidth: 1200,
            navigation: true,
            navigationPosition: 'right',
            navigationTooltips: ['home', 'about', 'portfolio', 'skill', 'services', 'testimonial', 'blog', 'instagram', 'contact'],
            scrollingSpeed: 1500,
            css3: false,
